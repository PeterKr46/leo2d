...
public class Texture {
    ...
    private List<TexContainer> hTex = new ArrayList<>();
    private int width = 0, height = 0;
    // Only for initialize from texture, not path.
    ...
    public Texture(String pDateiname) {
        ...
        try {
            ...
            System.out.println("Failed to read data from " + zDateiname);
            e.printStackTrace();
        }
    }
    ...
    public Texture(com.jogamp.opengl.util.texture.Texture lText) {
        ...
        this.hTex.add(new TexContainer(lText, Leo2D.getGL()));
